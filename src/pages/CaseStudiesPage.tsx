...
export function CaseStudiesPage({ primaryCTA, secondaryCTA }: CaseStudiesPageProps) {
  ...
  const testimonialsData = [
    {
      name: "Damain Player",
      title: "Founder & CEO at AI Integrator",
      quote: "The voice agent they built doesn't just make calls—it has conversations. Our close rate went from 12% to 31% because prospects actually engage instead of hanging up.",
      avatarSrc: "https://i.ibb.co/1JZZ0fXb/Screenshot-2025-09-27-at-7-07-45-PM.png",
      rating: 5.0,
    },
    {
      name: "Amit Kumar",
      title: "Co-Founder & CEO at Investors Propmart",
      quote: "I was spending 20 hours a week on lead follow-ups. Now the AI handles it all, and our conversion rate is actually higher. I got my weekends back.",
      avatarSrc: "https://i.ibb.co/TxwfJw7y/Screenshot-2025-09-27-at-7-07-57-PM.png",
      rating: 4.9,
    },
    {
      name: "Krish Aggarwal",
      title: "CEO at Rently",
      quote: "The system learns from every interaction. Last month it started proactively offering maintenance scheduling based on tenant inquiry patterns. That's not automation—that's intelligence.",
      avatarSrc: "https://i.ibb.co/6ckrxFFs/Screenshot-2025-09-27-at-7-08-06-PM.png",
      rating: 4.8,
    },
    {
      name: "Ganesh Shukla",
      title: "CEO & Founder at ADs For Profit",
      quote: "ROI hit 400% in month two. But honestly? The best part is sleeping through the night knowing every lead gets handled perfectly, even at 2 AM.",
      avatarSrc: "https://i.ibb.co/1tF0kXnQ/Screenshot-2025-09-27-at-7-08-29-PM.png",
      rating: 4.7,
    },
    {
      name: "Greg Shore",
      title: "Founder & CEO at Reigershore Consulting",
      quote: "They built our MVP in 3 weeks. Three weeks! And it wasn't some prototype—it was production-ready with billing, analytics, the works. Game changer.",
      avatarSrc: "https://i.ibb.co/nqhTgK1w/Screenshot-2025-09-27-at-7-09-39-PM.png",
      rating: 4.9,
    },
    {
      name: "Zachery Brown",
      title: "Founder & CEO at DealFinders PR",
      quote: "The voice agent handles objections better than most of our junior reps. It's patient, consistent, and never has a bad day. Our team actually learns from listening to its calls.",
      avatarSrc: "https://i.ibb.co/nMVVmtgf/Screenshot-2025-09-27-at-7-10-49-PM.png",
      rating: 4.9,
    },
  ];
