      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 h-screen">
        ...
        >
          <motion.h1
            ...
            style={{ fontFamily: '"Fraunces", Georgia, serif', letterSpacing: '-0.03em', fontWeight: 400 }}
          >
            Build Faster.
          </motion.h1>
          ...
          <motion.p
            ...
            style={{ fontFamily: '"Space Grotesk", -apple-system, BlinkMacSystemFont, system-ui, sans-serif', lineHeight: '1.8', letterSpacing: '0.01em' }}
          >
          ...
          <motion.p
            ...
            style={{ fontFamily: '"Space Grotesk", -apple-system, BlinkMacSystemFont, system-ui, sans-serif', lineHeight: '1.9', letterSpacing: '0.005em' }}
          >
