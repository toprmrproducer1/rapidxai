        ...
        <section className="py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gray-950 relative overflow-hidden">
            ...
            <div className="mx-auto max-w-7xl relative z-10">
                <div className="text-center mb-12 sm:mb-16 lg:mb-20">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-6 sm:mb-8 text-white tracking-tight">
                ...
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 sm:gap-6">
                        <Card className="relative col-span-full sm:col-span-2 lg:col-span-2 flex overflow-hidden bg-gray-900/50 border-gray-800/50 hover:border-purple-500/50 transition-all duration-300 backdrop-blur-sm">
                            <CardContent className="relative m-auto size-fit pt-6">
                                <div className="relative flex h-16 sm:h-20 lg:h-24 w-40 sm:w-48 lg:w-56 items-center">
                                    ...
                                    <span className="mx-auto block w-fit text-3xl sm:text-4xl lg:text-5xl font-semibold text-white">24/7</span>
                                </div>
                                <h2 className="mt-4 sm:mt-6 text-center text-xl sm:text-2xl lg:text-3xl font-semibold text-white">Always Available</h2>
                            </CardContent>
                        </Card>
                        
                        <Card className="relative col-span-full sm:col-span-1 lg:col-span-2 overflow-hidden bg-gray-900/50 border-gray-800/50 hover:border-purple-500/50 transition-all duration-300 backdrop-blur-sm">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-24 sm:size-28 lg:size-32 rounded-full border border-gray-700/50 before:absolute before:-inset-2 before:rounded-full before:border before:border-gray-700/30">
                                    <Shield className="m-auto h-fit w-12 sm:w-14 lg:w-16 text-purple-400" strokeWidth={1} />
                                </div>
                                <div className="relative z-10 mt-4 sm:mt-6 space-y-1 sm:space-y-2 text-center">
                                    <h2 className="text-base sm:text-lg font-medium text-white">Secure</h2>
                                    <p className="text-xs sm:text-sm text-gray-400">SOC2-ready.</p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative col-span-full sm:col-span-1 lg:col-span-2 overflow-hidden bg-gray-900/50 border-gray-800/50 hover:border-purple-500/50 transition-all duration-300 backdrop-blur-sm">
                            <CardContent className="pt-6">
                                <div className="pt-4 sm:pt-6 px-2 sm:px-4 lg:px-6">
                                    <div className="w-full flex items-center justify-center mb-6">
                                        <Zap className="w-12 sm:w-14 lg:w-16 h-12 sm:h-14 lg:h-16 text-violet-400" strokeWidth={1} />
                                    </div>
                                    <div className="bg-gradient-to-r from-purple-600/20 to-violet-600/20 rounded-lg p-3 sm:p-4 border border-purple-500/30">
                                        <div className="flex items-center justify-between mb-2">
                                            <span className="text-xs sm:text-sm text-gray-400">Speed</span>
                                            <span className="text-xs sm:text-sm text-purple-400">Weeks</span>
                                        </div>
                                        <div className="w-full bg-gray-800 rounded-full h-1.5 sm:h-2">
                                            ...
                                            <div className="bg-gradient-to-r from-purple-500 to-violet-500 h-1.5 sm:h-2 rounded-full" style={{width: '85%'}}></div>
                                        </div>
                                    </div>
                                </div>
                                <div className="relative z-10 mt-4 sm:mt-6 space-y-1 sm:space-y-2 text-center">
                                    <h2 className="text-base sm:text-lg font-medium text-white">Fast</h2>
                                    <p className="text-xs sm:text-sm text-gray-400">Weeks, not quarters.</p>
                                </div>
                            </CardContent>
                        </Card>
