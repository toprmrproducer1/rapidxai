      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <motion.h2 
            ...
            className="text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-6 sm:mb-8 text-white tracking-tight leading-tight" 
          ...
          <motion.p 
            variants={itemVariants}
            className="text-base sm:text-lg md:text-xl text-gray-300 max-w-3xl mx-auto font-light leading-relaxed mb-6 sm:mb-8" 
          ...
          >
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-purple-400 font-medium">Direct</span>
              </div>
              <p className="text-gray-300 mb-4 font-light">Call directly:</p>
              <div className="flex flex-col sm:flex-row gap-4">
                <a 
                  href="tel:+919307512816"
                  className="flex items-center gap-2 text-base text-white hover:text-purple-300 transition-colors font-mono bg-gray-800/50 rounded-xl px-3 py-2 hover:bg-gray-700/50"
                >
                ...
                <a 
                  ...
                  className="flex items-center gap-2 text-base text-white hover:text-green-300 transition-colors font-mono bg-gray-800/50 rounded-xl px-3 py-2 hover:bg-gray-700/50"
                >
