    ...
    <section id="services" className="py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-950 via-purple-950/20 to-gray-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-6 text-white tracking-tight">
            Our <span className="gradient-text">Core Services</span>
          </h2>
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed px-4">
            Voice automation + MVP development
          </p>
        </div>
              ...
              <>
                <div className="relative">
                  ...
                  <p className="text-lg md:text-xl text-gray-300 mb-8 leading-relaxed font-light">
                    24/7 receptionist + outbound SDR that never misses a follow-up.
                  </p>
                  ...
                  <div className="space-y-4 mb-8">
                    {[
                      ...
                      { icon: Zap, text: "CRM sync with notes & tasks" }
                    ].map((item, index) => (
                  ...
                  <p className="text-sm text-purple-400 mb-4">Go-live: 7–14 days</p>
                </div>
              </>
            )}
          </div>
            ...
            {activeService === 'mvp' && (
              <>
                <div className="relative">
                  ...
                  <p className="text-sm text-violet-400 mb-4">Time-to-live: 3–6 weeks</p>
                </div>
              </>
            )}
          </div>
